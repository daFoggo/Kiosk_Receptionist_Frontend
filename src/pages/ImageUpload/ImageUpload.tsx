  ...
  <div className="space-y-4">
    <DialogHeader>
      ...
      <DialogDescription className="text-justify">
        <p className="font-semibold">Các lưu ý khi chọn ảnh</p>
        <ul className="list-disc list-inside">
          ...
          <li>
            Chụp ảnh tại khu vực có ánh sáng tốt, không quá sáng, quá tối{" "}
          </li>
          ...
          {uploadedImages.map((image: any, index: number) => (
            <div key={index} className="relative">
              ...
              <button
                ...
                className="absolute top-1 right-1 bg-base rounded-full p-1"
