...
const EventManage = () => {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    const adjustedData = {
      ...data,
      start_time: formatInTimeZone(data.start_time, timeZone, "yyyy-MM-dd'T'HH:mm:ssXXX"),
      end_time: formatInTimeZone(data.end_time, timeZone, "yyyy-MM-dd'T'HH:mm:ssXXX"),
    };
  ...
  const eventDataColumns = [
    ...
    },
    {
      ...
      cell: ({ row }: any) => {
        ...
        return formatInTimeZone(parseISO(startTime), timeZone, "dd/MM/yyyy HH:mm:ss", { locale: vi });
      },
    },
    {
      ...
      cell: ({ row }: any) => {
        ...
        return formatInTimeZone(parseISO(endTime), timeZone, "dd/MM/yyyy HH:mm:ss", { locale: vi });
      },
    },
    {
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col">
                    ...
                    <FormControl>
                      <DateTimePicker
                        date={field.value}
                        setDate={(date: any) => field.onChange(toZonedTime(date, timeZone))}
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
