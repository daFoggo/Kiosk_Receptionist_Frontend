...
const Weather = () => {
  ...
  return (
    <div className="h-full rounded-3xl flex flex-col justify-center p-4  border border-slate-300 shadow-sm aspect-square font-semibold bg-white">
      <div className="flex flex-col items-start">
        <div className="flex justify-between items-center w-full font-bold">
          {weatherData.icon ? getWeatherIcon(weatherData.icon) : null}
          <p className="text-2xl text-indigo-950 ">Hôm nay</p>
        </div>
        <div className="flex items-baseline gap-2">
          <p className="text-6xl text-indigo-950 font-bold my-2">
